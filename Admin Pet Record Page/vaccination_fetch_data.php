<?php
    ...
    $sql = "SELECT * FROM vaccination WHERE recordID = ? ORDER BY vaccinationDate DESC"; // Modify as needed
    ...
    while ($record = mysqli_fetch_assoc($result)) {
        ...
        $actionButtons = "<button class='btn btn-primary btn-sm edit-btn' data-id='{$record['id']}'>Edit</button> " . "<button class='btn btn-danger btn-sm delete-btn' data-id='{$record['id']}'>Delete</button>";
